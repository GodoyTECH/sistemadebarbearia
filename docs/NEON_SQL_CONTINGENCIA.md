...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS approved_by_user_id varchar;
...
UPDATE profiles SET approval_status = 'pending_approval' WHERE role = 'professional' AND shop_id IS NOT NULL AND approval_status = 'active';
```
