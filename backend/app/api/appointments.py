...
from app.api.deps import get_db, get_current_user, get_current_profile, require_admin
...
def create_appointment(
    ...
    if profile and profile.role != "professional":
        raise HTTPException(status_code=403, detail="Only professionals can create appointments")
...
@router.patch("/{appointment_id}/status", response_model=AppointmentBase, dependencies=[Depends(require_admin)])
def update_status(
    appointment_id: int,
